...
//---------------------------------
$homme = new Homme;
// $homme ->  prenom = 'Anthony'; //ERREUR : propriété private donc innaccessible à l'intérieur de la classe
// echo $homme -> prenom;

$homme -> setPrenom('Anthony');
...
/*
    Commenataires :
        ...
        On aura autant de getter et de setter que des propriétés private
