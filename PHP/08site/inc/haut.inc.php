    ...
    <nav class"navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php RACINE_SITE . 'boutique.php'; ?>">Ma Boutique</a>
            </div>
                    ...
                    <?php
                        ...
                        //Menu admin :
                            if(internauteEstConnecteEtEstAdmin()){
                                ...
                                echo '<li><a href="'.RACINE_SITE.'gestion_commande.php">Gestion des commandes</a></li>';

                                echo '<li><a href="'.RACINE_SITE.'gestion_membre.php">Gestion des membres</a></li>';
                            }
