...
// ---------------------------------------
echo '<h2> Cas pratique : un espace de commentaires </h2>';
// ---------------------------------------
...
//2. Connexion à la BDD et traitement du post :
    ...
    if(!empty($_POST)){
        ...
        $_POST['message'] = strip_tags($_POST['message']); //permet de supprimer toutes les balises HTML.
            ...
            //htmlentites() permet lui aussi de convertir les balises HTML en tenités HTML.
        ...
        //2-Nous allons faire une injection SQL : dans le champ message, saisir:
...
<?php
    //3. Affichage des messages contenus en BDD :
