...
//*****************************************
    ...
    /*
        Le terme de SESSION désigne la période de temps correspondant à la navigation continue de l'internaute sur un site: continue, car si l'internaute ferme le navigateur, la session s'interrompts.

        Principe : un fichier temporaire appelé sesion est créé sur le serveur, avec un identifiant unique. Cette session est liée à un internaute car, dans le même temps, un cookie est déposé sur le poste de l'internaute avec l'identifiant. Ce cookie se détruit lorsqu'on quitte le navigateur.

        On stocke entre autre dans une session, les paniers d'achats ou les informations de connexion. Ces informations sont paccessibles dans tous les scripts du site grâce à la session.
    */
